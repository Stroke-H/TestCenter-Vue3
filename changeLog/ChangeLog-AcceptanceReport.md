...
### Added
- **Managed Defect Prefill**: 新建验收报告选择项目并填写版本后，自动匹配缺陷管理中同项目、同数字版本的全部未归档缺陷（例如 `1.1.1` 与 `v1.1.1` 视为同版本），按缺陷创建顺序编号填入“当前版本缺陷提交及修复情况”。缺陷仅来源于平台缺陷管理，不再查询或兜底使用飞书项目数据；“测试需求点”保持手动填写。

## 2026-07-22

### Changed
- **Bug Status Semantics**: 验收报告中的“缺陷修复情况”调整为“当前版本缺陷提交及修复情况”，对应飞书报告的“本次预提审版本缺陷提交情况”；“缺陷提交情况”调整为“历史版本遗留缺陷修复情况”，对应“正式版本缺陷修复验证情况”。
- **Empty Status Fallback**: 发送飞书报告或同步云文档时，未填写的缺陷情况统一显示为“无”。
